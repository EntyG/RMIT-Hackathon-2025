...
const events = [
        ...
        { title: "Coastal Flood", image: "event-flood.png", description: "A coastal flood hits the southern farms! The bottom two rows of crops take 30 damage.", effect: (gs) => { for(let r = 3; r < 5; r++) { for (let c = 0; c < 5; c++) { const tile = gs.board[r][c]; if (tile.health) tile.health -= 30; } } } },
